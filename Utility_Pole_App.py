            ...
            if input_type == 'Input Single Street Address':
                ...
                try:
                    ...
                    if st.button("Predict"):
                        ...
                        predicted_images_with_pole, total_images_folder, data, df_load = Detection_downloaded(downloaded_image_path, region_name = ups_download(Address, api_key = "??"))
                        ...
                        st.success(fig.show())
                        st.download_button("Press to Download", data_frame, "region_name.csv", "text/csv", key='download-csv')

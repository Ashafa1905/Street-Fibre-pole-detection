...
def save_uploadedfile(uploadedfile):
     with open(os.path.join("/home/explore-student/pole_detection/T12_Streamlit_app/uploaded_images", uploadedfile.name),"wb") as f:
         f.write(uploadedfile.getbuffer())
     return st.success("Saved File:{} to uploaded_images".format(uploadedfile.name))
path = "/home/explore-student/pole_detection/T12_Streamlit_app/downloaded_images/*"
path1 = "/home/explore-student/pole_detection/T12_Streamlit_app/Single_street_download"
...
def ups_download(address, api_key, buffer = 500):
    ...
    for location in coords:
      ...
      with open(f'/home/explore-student/pole_detection/T12_Streamlit_app/downloaded_images/{name}.jpg', 'wb') as file:
...
def ups_download_singleAddress(address, api_key):
    ...
    for angle in range(len(angles)):
      ...
      print(name)
      pic_response = requests.get(base_url, params=pic_params)
      with open(f'/home/explore-student/pole_detection/T12_Streamlit_app/Single_street_download/{name}.jpg', 'wb') as file:
          file.write(pic_response.content)
          pic_response.close()
          #i+=1
    return address
...
cuda = False
w = "/home/explore-student/pole_detection/T12_Streamlit_app/pole_model.onnx"
...
downloaded_image_path1 = '/home/explore-student/pole_detection/T12_Streamlit_app/Single_street_download/*.jpg'
...
downloaded_image_path = '/home/explore-student/pole_detection/T12_Streamlit_app/downloaded_images/*.jpg'
def Detection_downloaded(image_path, region_name):
    ...
    df.to_csv(f'/home/explore-student/pole_detection/T12_Streamlit_app/csv_files/{region_name}.csv', index=False, header=True)
    #df_load = pd.read_csv(f'/home/explore-student/pole_detection/T12_Streamlit_app/csv_files/{region_name}.csv')
    return images_with_poles, total_images, df
...
def main():
    ...
    if selection == "Task":
        ...
        if choice == "Utility Pole Detection(Image)":
            ...
            if image_file is not None:
                ...
                #Saving upload
                with open(os.path.join("/home/explore-student/pole_detection/T12_Streamlit_app/uploaded_images", image_file.name),"wb") as f:
            ...
            if st.button("Process"):
                ...
                try:
                    image_path = '/home/explore-student/pole_detection/T12_Streamlit_app/uploaded_images/{}'.format(file_details['filename'])
                    ...
                    st.success('Process Completed, you can use other functions of the app.')
            ...
            if input_type == 'Input Single Street Address':
                ...
                if st.button("Download images"):
                    ...
                    try: 
                        ...
                        _, _, files = next(os.walk("/home/explore-student/pole_detection/T12_Streamlit_app/Single_street_download"))
                ...
                try:
                    if st.button("Click to Download images"):
                        ...
                        _, _, files = next(os.walk("/home/explore-student/pole_detection/T12_Streamlit_app/downloaded_images"))
                        file_count = len(files)
                        st.success(f'{file_count} images downloaded successfully from the address provided')
                    
                    if st.button("Predict"):

                        predicted_images_with_pole, total_images_folder, data = Detection_downloaded(downloaded_image_path, region_name = ups_download(Address, api_key = "AIzaSyCpF1uPQLSCrx2CdsLLF_dbaZVEQDC1TE4"))
                        ...
                        df_load = pd.read_csv(f'/home/explore-student/pole_detection/T12_Streamlit_app/csv_files/{Address}.csv')

                        #csv = pd.read_csv('data_frame.csv')
                        fig = px.scatter_mapbox(df_load, lat = "Latitude", lon = "Longitude", color="Fibre_Pole_Present", zoom=10, mapbox_style='open-street-map')
                        st.write(fig)
                        st.download_button("Click to Download csv", data_frame, f"{Address}.csv", "text/csv", key='download-csv')
    ...
    if selection == "About Us":
        ...
        if type == 'Documentation':
            ...
            st.subheader("Godwin (Asst. Team Leader)")
            ...
            st.subheader("Micheal (Team Admin)")
            ...
            st.header("Basheer  (Asst. Technical Lead)")
